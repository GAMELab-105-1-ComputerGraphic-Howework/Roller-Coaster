...
{
	trainview->speedAndDir = (float(val) / 100.0f - 0.5) / 0.5 * 5;
}
...
void AppMain::DeleteControlPoint()
{
	...
	this->trainview->m_pTrack->train1ControlPoint = 3;
	this->trainview->m_pTrack->train1Point = 0;

	this->trainview->m_pTrack->train2ControlPoint = 0;
	this->trainview->m_pTrack->train2Point = 0;

	this->trainview->m_pTrack->nightHawkControlPoint = 1;
	this->trainview->m_pTrack->nightHawkPoint = 0;

	this->trainview->m_pTrack->fighterControlPoint = 2;
	this->trainview->m_pTrack->fighterPoint = 0;
